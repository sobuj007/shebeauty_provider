...
class SubCategoryListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final subCategory = Get.arguments['subCategory'] as Category?;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            15.ph,
            Expanded(
                child: Obx(() => controller.filteredSubCategories.isEmpty ?  Center(
                  ...
                  children: controller.filteredSubCategories
                    ...
                    onTap: (){
                      controller.filteredBodyPartCategories.value = controller.allBodyPartCategories
                          .where((bodyPart) => item.id.toString() == bodyPart.subcategoryId)
                          .toList();
                      Get.toNamed(AppRoutes.bodyPart,arguments: {
                      'bodypart': item,
                      },);
                    },
                      child: Card(
